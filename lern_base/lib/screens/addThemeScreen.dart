                  ...
                  Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        chekValidFunc();
                        if (chekValid == true) {
                          print('Есть незаполненые поля');
                        };
                        // print(newWorlds);
                        // var testVar = ListTheme(name: nameTheme, allElements: [
                        //
                        // ]);
                        // print(testVar.dict);
                      },
